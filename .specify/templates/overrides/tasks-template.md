...
### Tests for User Story 1 *(required for executable apps — write FIRST, must FAIL before implementation)*
...
### Tests for User Story 2 *(required for executable apps — FIRST, must FAIL)*
...
### Tests for User Story 3 *(required for executable apps — FIRST, must FAIL)*

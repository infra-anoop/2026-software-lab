...
7. `/speckit-tasks` → `/speckit-implement`  
8. Optional: `notes/packets/` for a long background slice  
...
- `specs/smart-writer-v2/` **Approved** spec + **Approved** plan (P1–P8) — next `/speckit-tasks`.

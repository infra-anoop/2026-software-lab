...
| **Tests** (contract/auto) | [`docs/agent-os/TEST_REVIEW_PROMPT.md`](../../docs/agent-os/TEST_REVIEW_PROMPT.md) | **T-*** |
...
**Spec + plan Approved** (F*/R*/P*). Next: `/speckit-tasks` (tests required) → T* when contract tests exist → implement.
